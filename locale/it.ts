...
const messages = {
  index: {
    ...
    header: {
      ...
      teenhackers: "giovani hackers",
      aroundtheworld: "da tutto il mondo che programmano insieme",
      outernetpic: "Hackers at Outernet in Vermont",
      outernetpictitle: "📸 Foto di Matt Gleich, Hack Clubber in NH!"
    },
    headerbuttons: {
      slack: "Unisciti sur Slack",
      mainsite: "Sito Principale (inglese)",
      mainsitesubtext: "per più infomazioni!"
    },
    firstsection: {
      discoverthe: "Scopri il",
      joyofcode: "piacere di programmare",
      together: ", insieme.",
      everydaytext: `Ogni giorno, Migliaia di Hack\u00A0Clubbers si incontrano online e
      di persona per creare cose programmando. Che tu sia un programmatore principiante o che tu abbia anni di esperienza, c'è un posto per te in
      Hack\u00A0Club. Scopri di più sulla nostra `,
      hackerethic: "etica hacker"
    },
    steps: {
      step1: {
